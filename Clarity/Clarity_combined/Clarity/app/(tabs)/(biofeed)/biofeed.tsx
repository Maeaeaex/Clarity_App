    ...
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.explanation}>
          ...
          If the app detects your mind wander, it will help you come back to the present moment by an AI voice cue.
          This leads to faster, better meditation learning.
        </Text>
      </View>
    </View>
  );
