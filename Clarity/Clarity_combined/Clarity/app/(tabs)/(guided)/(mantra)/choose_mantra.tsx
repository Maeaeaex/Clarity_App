      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <View style={styles.buttonWrapper}>
            ...
            <AudioButtonTry audioFile={require("../../../../assets/audio/mantra.mp3")} playText="Learn mantra meditation"/>
          </View>
          <View style={styles.buttonWrapper}>
          ...
          <View style={styles.buttonWrapper}>
            ...
            <AudioButtonTry audioFile={require("../../../../assets/audio/kindness.mp3")} playText="Loving-Kindness-Mantra"/>
          </View>
