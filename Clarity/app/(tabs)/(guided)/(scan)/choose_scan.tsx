...
import AudioButton from "@/components/AudioButton"; //ich hier mein button
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <View style={styles.buttonWrapper}>
            ...
            <AudioButton audioFile={require("../../../../assets/audio/body.mp3")} playText="Learn Body Scan"/>
          </View>
          <View style={styles.buttonWrapper}>
            {/*<Button label="Shutting off the Body" />*/}
            <AudioButton audioFile={require("../../../../assets/audio/body_relax.mp3")} playText="Shutting off the Body"/>
          </View>
          <View style={styles.buttonWrapper}>
