    ...
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.explanation}>
          ...
          The meditator practises concentration by focusing on either the abdominal movement of the belly or the nasal area.

          This practice leads to a deepening of the connection between the meditator and their breath.

          Ultimately, this leads to a calm, deep meditative state.
        </Text>
      </View>
