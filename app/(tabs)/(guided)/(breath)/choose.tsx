...
import AudioButton from "@/components/AudioButton"; // nicht mehr nötig
//import AudioButtonTwo from "@/components/AudioButtonTwo"; //ich hier mein button, nicht mehr nötig
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <View style={styles.buttonWrapper}>
          ...
          <AudioButtonTry audioFile={require("../../../../assets/audio/test.mp3")} playText="Learn how to breathe"/>
        </View>
        <View style={styles.buttonWrapper}>
          {/*<Button label="4/7/8 - breathing methode" />*/}
          <AudioButtonTry audioFile={require("../../../../assets/audio/4-7-8.mp3")} playText="4/7/8 - breathing methode"/>
        </View>
        <View style={styles.buttonWrapper}>
          <AudioButtonTry audioFile={require("../../../../assets/audio/stress.mp3")} playText="Breathing to manage stress"/>
        </View>
